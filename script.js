...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const animateElements = document.querySelectorAll(
    ".service-card, .info-item, .access-item, .contact-method",
  );
  ...
  const slideLeftElements = document.querySelectorAll(
    ".about-text, .message-text, .contact-info",
  );
  ...
  const slideRightElements = document.querySelectorAll(
    ".about-image, .message-image, .contact-form, .map-container",
  );
  ...
  const cards = document.querySelectorAll(
    ".service-card, .info-item, .access-item",
  );
  cards.forEach((card) => {
